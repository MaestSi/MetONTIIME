...
* \<sampling_depth\>: minimum number of reads required for a sample to be included in the analysis; this value can be chosen looking at demu_summary.qzv or at logfile.txt
* \<threads\>: number of threads used for generating the phylogenetic tree

Outputs:

* core-metrics-results: folder containing some alpha and beta diversiry metrics
* alpha-rarefaction.qzv: visualization artifact describing alpha diversity as a function of sampling depth
* aligned-repseqs.qza, rooted-tree.qza and unrooted-tree.qza: temporary files generated for calculating diversity metrics
